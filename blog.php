                     ...
                     <div class="row marginii">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div class="carousel-caption ">
                              ...
                              <p>In some Native languages the term for plants translates to “those who take care of us.”</p>
            ...
            <div class="row">
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                  <div class="plants-box">
                     ...
                     <p>passionate look, touch or a hug on a plant is enough to open your inner eyes than going for a serious yoga and other therapies</p>
                  </div>
               </div>
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                  <div class="plants-box">
                     ...
                     <p>Organic foods are richer in nutrients. This means they improve satiety and naturally help regulate body weight…Plants produce antioxidants to protect themselves from pests like insects and to withstand harsh weather. When they’re treated with chemicals such as pesticides, they don’t need to produce as much of their own natural defenses, so the levels are lower.</p>
                  </div>
               </div>
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                  <div class="plants-box">
                     ...
                     <h3> Dried Plant</h3>
                     <p>A dried plant is nothing but a sign to plant a new one</p>
                  </div>
               </div>
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                  <div class="plants-box">
                     <figure><img src="images/plant1.jpg" alt="img"/></figure>
                     <h3> Gardening </h3>
                     <p>It is not hard to start a small garden, all you need is a sapling, a planting pot, a small bag of soil, and regular watering. There you go, you helped cooling the earth down by one plant</p>
                  </div>
               </div>
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                  <div class="plants-box">
               ...
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                  <div class="plants-box">
                     <figure><img src="images/plant3.jpg" alt="img"/></figure>
                     <h3> Cactus Story</h3>
                     <p>The cactus thrives in the desert while the fern thrives in the wetland.
...
The child will turn it around properly so that the fern is in the shade, and not the cactus.</p>
                  </div>
               </div>
            </div>
         </div>
...
<div id="blog" class="blog">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
      <form class="form" action="blg.php" method="post">
      <p class="name">
      ...
      <p class="text">
        <textarea name="blog" class="validate[required,length[6,300]] feedback-input" id="blog" placeholder="Your Blog"></textarea>
      </p>
               ...
               <div class="row pdn-top-30">
                  <div class="col-md-12 ">
                     <div class="footer-box">
                        <div class="headinga">
                           <h3>Address</h3>
                           <span>Demo Store .Mohakhali,Dhaka,bangladesh</span>
                           <p>(+8801705971936)</p>
                        </div>
