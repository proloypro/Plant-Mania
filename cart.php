                    ...
                    <div>
                        <div class="shipping d-flex justify-content-between">
                            ...
                            <div class="shipping-address">
                                  <form action="carty.php" method="post">
                                   <input type="text"class="country" name="country" id="country" placeholder="Plant Id">
                                    <input type="text" class=" state" name="state" id="state" placeholder="Plahnt Name">
                                    <input type="text" class="zip" name="zip" id="zip" placeholder="Quantity">
